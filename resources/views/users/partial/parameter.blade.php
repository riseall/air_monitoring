<div
    ...
    <div class="border-black/12.5 mb-0 rounded-2xl border-b-0 border-solid bg-white p-6">
        <div class="w-full bg-white rounded-lg -mb-36">
            ...
            <div class="relative grid lg:grid-cols-6 md:grid-cols-3 sm:grid-cols-2 gap-8 z-20 pt-4">
                <div class="cardpar">
                    ...
                    <div class="py-2">
                        ...
                        <i class="text-sm leading-normal font-weight-bolder text-lime-500">ug/m<sup>3</sup></i>
                    </div>
        ...
        <div class="relative w-full h-64"> <!-- Adjust height as needed -->
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" class="absolute inset-0 z-10 w-full h-full">
