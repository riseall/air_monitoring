            ...
            <div class="w-full max-w-full px-3 mt-0 mb-6 lg:mb-0 lg:w-1/2 lg:flex-none">
                <div
                    ...
                    <div class="border-black/12.5 mb-0 rounded-t-2xl border-b-0 border-solid bg-white p-6 pb-0">
                        <h6>Grafik Kualitas Udara</h6>
                        <select
                            class="p-1 rounded-md text-xs bg-gradient-to-br from-slate-600 via-slate-700 to-slate-800 text-white"
                            id="parameter1" name="parameter1">
